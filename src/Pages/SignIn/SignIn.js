        ...
        <div>
          <div className="my-2 ">
            <div className="  flex justify-between">
              <label className="font-bold" htmlFor="buyer-email">
                buyer:{" "}
              </label>
              <div className="flex justify-end mb-1">
                ...
                />
                <button
                  onClick={() => copyCredential("buyer-email")}
                  className="ml-1 "
                >
                  {copyItem === "buyer-email" ? (
                    <svg
            ...
            <div className="  flex justify-between ">
              <label className="font-bold" htmlFor="buyer-password">
                password:{" "}
              </label>
              ...
              <div className="flex justify-end mb-1">
                ...
                />
                <button
                  onClick={() => copyCredential("buyer-password")}
                  className="ml-1 "
                >
                  {copyItem === "buyer-password" ? (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
          ...
          <div className="my-2">
            <div className="  flex justify-between">
              <label className="font-bold" htmlFor="seller-email">
                seller:{" "}
              </label>
              ...
              <div className="flex justify-end mb-1">
                ...
                />
                <button
                  onClick={() => copyCredential("seller-email")}
                  className="ml-1 "
                >
                  {copyItem === "seller-email" ? (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
            ...
            <div className="  flex justify-between">
              <label className="font-bold" htmlFor="seller-password">
                password:{" "}
              </label>
              ...
              <div className="flex justify-end mb-1">
                ...
                />
                <button
                  onClick={() => copyCredential("seller-password")}
                  className="ml-1 "
                >
                  {copyItem === "seller-password" ? (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
          ...
          <div className="my-2">
            <div className="  flex justify-between">
              ...
              <div className="flex justify-end mb-1">
                ...
                />
                <button
                  onClick={() => copyCredential("admin-email")}
                  className="ml-1 "
                >
                  {copyItem === "admin-email" ? (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
            ...
            <div className="  flex justify-between">
              <label className="font-bold" htmlFor="admin-password">
                password:{" "}
              </label>
              ...
              <div className="flex justify-end mb-1">
                ...
                />
                <button
                  onClick={() => copyCredential("admin-password")}
                  className="ml-1 "
                >
                  {copyItem === "admin-password" ? (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
